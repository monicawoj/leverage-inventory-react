...
const Routes = (parentProps) => (
  <Switch>
    ...
    <Route exact path="/your-leverage-inventory/your-results/your-leverage-inventory-your-results-print/" render={(props) => <PrintUserResultsPage location={props.location} {...parentProps} />} />
