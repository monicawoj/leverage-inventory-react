  ...
  const stats = (
    ...
    >
      <CenteredText
        ...
        dy="1em"
      >
        {`Correlation: ${correlation} (group mean = ${correlationGroupMean})`}
      </CenteredText>
      <CenteredText
        className="subtitle has-text-weight-bold"
        dy="1em"
        ...
        y={20}
      >
        {`Bias: ${bias} (group mean = ${biasGroupMean})`}
      </CenteredText>
    </g>
  );
  ...
  return (
    <Fragment>
      ...
      >
        ...
        <CenteredText
          className="label"
          y={svgDimensions.height - margin.bottom + (margin.top/4)}
